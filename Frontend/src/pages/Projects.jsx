...
function Projects() {
    ...
    const ProjectCard = ({ project }) => (
        <div className="card hover:shadow-xl transition-all transform hover:scale-105">
            ...
            <p className="text-gray-600 text-sm mb-4 line-clamp-2">{project.description || 'Pas de description'}</p>
            
            <div className="flex items-center justify-between mb-4 pb-4 border-b border-gray-200">
                <span className="text-sm text-gray-600">Budget: <span className="font-semibold text-blue-600">{project.budget}€</span></span>
