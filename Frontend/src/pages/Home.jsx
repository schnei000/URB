    ...
    <div className="bg-gradient-to-b from-[#F5F7FA] to-white dark:from-[#1A1B2D] dark:to-[#111220] text-[#202225] dark:text-slate-100">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-center lg:text-left space-y-8 animate-fade-in-up">
            <h1 className="text-5xl md:text-6xl font-extrabold tracking-tighter">
              ...
              <span className="text-[#2A68FF]">maîtrisez la puissance.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4" style={{ animationDelay: '0.2s' }}>
              <Link to="/register" className="btn-primary text-lg transform transition-transform hover:scale-105">
                Commencer Gratuitement
              </Link>
              <Link to="/demo" className="btn-outline text-lg transform transition-transform hover:scale-105 ">
          ...
          <div className="hidden lg:block animate-float">
            <div className="bg-white dark:bg-slate-800 rounded-lg shadow-xl p-4">
      ...
      <section className="py-16 bg-white dark:bg-slate-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h3 className="text-center text-lg font-semibold text-slate-600 dark:text-slate-400">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            <div className="card text-center transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl animate-fade-in-up">
              <LayoutDashboard size={40} className="mx-auto mb-4 text-[#2A68FF]" />
              <h3 className="text-xl font-bold mb-2">Tableaux de bord en temps réel</h3>
              <p className="text-slate-600 dark:text-slate-400 font-light">Visualisez l'état, les statistiques et les goulots d'étranglement de tous vos projets en une seule interface claire.</p>
            </div>
            <div className="card text-center transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
              <Users size={40} className="mx-auto mb-4 text-[#2A68FF]" />
              <h3 className="text-xl font-bold mb-2">Collaboration sans friction</h3>
              <p className="text-slate-600 dark:text-slate-400 font-light">Partagez des fichiers, assignez des tâches et communiquez avec vos clients ou votre équipe sans changer d'outil.</p>
            </div>
            <div className="card text-center transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
              <Rocket size={40} className="mx-auto mb-4 text-[#2A68FF]" />
      ...
      <section className="bg-gradient-to-r from-[#2A68FF] to-blue-500 dark:from-[#2A68FF] dark:to-blue-800">
        <div className="max-w-4xl mx-auto text-center py-16 px-4 sm:px-6 lg:px-8">
          ...
          <Link to="/register" className="mt-8 btn-primary bg-white hover:bg-slate-100 text-[#2A68FF] text-lg transform transition-transform hover:scale-105">
